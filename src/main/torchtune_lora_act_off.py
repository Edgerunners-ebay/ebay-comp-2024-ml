...
from src.data.lora_main import get_dataloader_and_sampler
...
class LoRAFinetuneRecipeSingleDevice(FTRecipeInterface):
    ...
    def _setup_data(
        self, cfg_dataset, shuffle, batch_size
    ) -> Tuple[Sampler, DataLoader]:
        return get_dataloader_and_sampler(cfg_dataset, shuffle, batch_size)
...
if __name__ == "__main__":
    # yaml to DictConfig using omegaconf
    cfg = OmegaConf.load(
        file_="/home/017534556/projects/ebay-comp-2024/src/configs/base_qlora_llama3_1_8B_single_device.yaml"
    )
    recipe_main(cfg=OmegaConf.to_container(cfg, resolve=True))
    print("Done!")
