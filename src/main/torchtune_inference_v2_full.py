...
from src.utils.helper import calculate_varentropy_logsoftmax, process_output_efficient
...
class InferenceRecipe:
    ...
    def __init__(self, cfg: DictConfig) -> None:
        ...
        self._logger.debug(f"Device: {self._device}, dtype: {self._dtype}")
    ...
    def _setup_submission(self, cfg):
        ...
        self.client = Client(server_ip="172.16.3.218", port=8000)
        self._conn = db_connect(self._db_root / "submissions_bak.db")
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    return
        process_output_efficient(self._conn, self._cfg, record_id, output=json_content)
...
#         thread = threading.Thread(target=work, args=(cfg,))
